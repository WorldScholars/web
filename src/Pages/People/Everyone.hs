...
fiona = Person{
  headshotLink = "",
  name = "Fiona Santolucito (Head of Operations)",
...
santolucito = Person{
  headshotLink = "",
  name = "Mark Santolucito (Head of Technology)",
...
maria = Person{
  headshotLink = "",
  name = "Maria Hwang (Head of Design)",
...
jacob = Person{
  headshotLink = "",
  name = "Jacob Li (Head of Business Development)",
